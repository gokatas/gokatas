...
Katas (形) are practiced in martial arts as a way to internalize and perfect techniques, so they can be executed and adapted under various circumstances without much hesitation. Let's try something similar with Go programming. Go katas is a selected set of [repositories](https://github.com/orgs/gokatas/repositories) containing small Go programs written by experts. They are the mental building blocks that you can re-use when writing Go code. The practice workflow is straightforward:
